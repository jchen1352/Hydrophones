-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hydrophone\Complex3Multiply_block10.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex3Multiply_block10
-- Source Path: hydrophone/Subsystem/FFT HDL Optimized2/RADIX22FFT_SDF1_9/Complex3Multiply
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Complex3Multiply_block10 IS
...
END Complex3Multiply_block10;


ARCHITECTURE rtl OF Complex3Multiply_block10 IS
  ...
  SIGNAL adder_add_cast                   : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL adder_add_cast_1                 : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL din_sum                          : signed(25 DOWNTO 0);  -- sfix26_En14
  ...
  SIGNAL Complex3Multiply_din1_re_pipe1   : signed(24 DOWNTO 0);  -- sfix25
  SIGNAL Complex3Multiply_din1_im_pipe1   : signed(24 DOWNTO 0);  -- sfix25
  SIGNAL Complex3Multiply_din1_sum_pipe1  : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL Complex3Multiply_prodOfRe_pipe1  : signed(40 DOWNTO 0);  -- sfix41
  SIGNAL Complex3Multiply_ProdOfIm_pipe1  : signed(40 DOWNTO 0);  -- sfix41
  SIGNAL Complex3Multiply_prodOfSum_pipe1 : signed(42 DOWNTO 0);  -- sfix43
  ...
  SIGNAL prodOfRe                         : signed(40 DOWNTO 0);  -- sfix41_En28
  SIGNAL prodOfIm                         : signed(40 DOWNTO 0);  -- sfix41_En28
  SIGNAL prodOfSum                        : signed(42 DOWNTO 0);  -- sfix43_En28
  ...
  SIGNAL Complex3Add_tmpResult_reg_next   : signed(42 DOWNTO 0);  -- sfix43_En28
  SIGNAL Complex3Add_multRes_re_reg1_next : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL Complex3Add_multRes_re_reg2_next : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL Complex3Add_multRes_im_reg_next  : signed(43 DOWNTO 0);  -- sfix44_En28
  SIGNAL Complex3Add_sub_cast             : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL Complex3Add_sub_cast_1           : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL Complex3Add_sub_cast_2           : signed(43 DOWNTO 0);  -- sfix44_En28
  SIGNAL Complex3Add_sub_cast_3           : signed(43 DOWNTO 0);  -- sfix44_En28
  SIGNAL Complex3Add_add_cast             : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL Complex3Add_add_cast_1           : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL Complex3Add_add_temp             : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL multResFP_re                     : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL multResFP_im                     : signed(43 DOWNTO 0);  -- sfix44_En28
...
BEGIN
  ...
  dinXTwdl_re_tmp <= multResFP_re(38 DOWNTO 14);

  dinXTwdl_re <= std_logic_vector(dinXTwdl_re_tmp);

  dinXTwdl_im_tmp <= multResFP_im(38 DOWNTO 14);
