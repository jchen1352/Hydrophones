-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hydrophone\RADIX22FFT_SDF2_10_block1.vhd
...
-- Source Path: hydrophone/Subsystem/FFT HDL Optimized2/RADIX22FFT_SDF2_10
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX22FFT_SDF2_10_block1 IS
  ...
  SIGNAL din_re_dly1                      : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL btfin_re                         : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL din_im_dly1                      : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL btfin_im                         : signed(25 DOWNTO 0);  -- sfix26_En14
  ...
  SIGNAL x_im                             : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL x_im_dly                         : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL wrData_im                        : std_logic_vector(25 DOWNTO 0);  -- ufix26
  SIGNAL wrData_im_signed                 : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL wrData_re                        : std_logic_vector(25 DOWNTO 0);  -- ufix26
  SIGNAL wrData_re_signed                 : signed(25 DOWNTO 0);  -- sfix26_En14
  ...
  SIGNAL twoLocationReg_0_MEM_re_0_next   : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL twoLocationReg_0_MEM_im_0_next   : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL twoLocationReg_0_MEM_re_1_next   : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL twoLocationReg_0_MEM_im_1_next   : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL twoLocationReg_0_dout_re_reg_next : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL twoLocationReg_0_dout_im_reg_next : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL x_re                             : signed(25 DOWNTO 0);  -- sfix26_En14
...
BEGIN
  ...
  twoLocationReg_0_output : PROCESS (twoLocationReg_0_MEM_re_0, twoLocationReg_0_MEM_im_0,
       ...
       wrData_re_signed, wrData_im_signed, wrAddr, wrEnb, rd_10_Addr)
  BEGIN
  ...
  Radix22ButterflyG2_output : PROCESS (Radix22ButterflyG2_procEnb_dly, Radix22ButterflyG2_procEnb_dly1,
       ...
       x_im_dly, x_vld_dly, multiply_10_J)
