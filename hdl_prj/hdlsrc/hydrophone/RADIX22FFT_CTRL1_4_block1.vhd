-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hydrophone\RADIX22FFT_CTRL1_4_block1.vhd
...
-- Source Path: hydrophone/Subsystem/FFT HDL Optimized2/RADIX22FFT_CTRL1_4
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX22FFT_CTRL1_4_block1 IS
  ...
  SIGNAL rd_4_Addr_tmp                    : unsigned(5 DOWNTO 0);  -- ufix6
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_4_Enb <= '0';
        IF (dout_3_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#3F#, 6))) = '1' THEN 
