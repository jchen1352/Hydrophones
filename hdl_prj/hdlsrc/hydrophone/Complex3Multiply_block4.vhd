-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hydrophone\Complex3Multiply_block4.vhd
...
-- Source Path: hydrophone/Subsystem/FFT HDL Optimized1/RADIX22FFT_SDF1_5/Complex3Multiply
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Complex3Multiply_block4 IS
  ...
  SIGNAL adder_add_cast                   : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL adder_add_cast_1                 : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL din_sum                          : signed(21 DOWNTO 0);  -- sfix22_En14
  ...
  SIGNAL Complex3Multiply_din1_re_pipe1   : signed(20 DOWNTO 0);  -- sfix21
  SIGNAL Complex3Multiply_din1_im_pipe1   : signed(20 DOWNTO 0);  -- sfix21
  SIGNAL Complex3Multiply_din1_sum_pipe1  : signed(21 DOWNTO 0);  -- sfix22
  ...
  SIGNAL prodOfRe                         : signed(36 DOWNTO 0);  -- sfix37_En28
  SIGNAL prodOfIm                         : signed(36 DOWNTO 0);  -- sfix37_En28
  SIGNAL prodOfSum                        : signed(38 DOWNTO 0);  -- sfix39_En28
  ...
  SIGNAL Complex3Add_tmpResult_reg_next   : signed(38 DOWNTO 0);  -- sfix39_En28
  SIGNAL Complex3Add_multRes_re_reg1_next : signed(37 DOWNTO 0);  -- sfix38_En28
  SIGNAL Complex3Add_multRes_re_reg2_next : signed(37 DOWNTO 0);  -- sfix38_En28
  SIGNAL Complex3Add_multRes_im_reg_next  : signed(39 DOWNTO 0);  -- sfix40_En28
  SIGNAL Complex3Add_sub_cast             : signed(37 DOWNTO 0);  -- sfix38_En28
  SIGNAL Complex3Add_sub_cast_1           : signed(37 DOWNTO 0);  -- sfix38_En28
  SIGNAL Complex3Add_sub_cast_2           : signed(39 DOWNTO 0);  -- sfix40_En28
  SIGNAL Complex3Add_sub_cast_3           : signed(39 DOWNTO 0);  -- sfix40_En28
  SIGNAL Complex3Add_add_cast             : signed(37 DOWNTO 0);  -- sfix38_En28
  SIGNAL Complex3Add_add_cast_1           : signed(37 DOWNTO 0);  -- sfix38_En28
  SIGNAL Complex3Add_add_temp             : signed(37 DOWNTO 0);  -- sfix38_En28
  SIGNAL multResFP_re                     : signed(37 DOWNTO 0);  -- sfix38_En28
  SIGNAL multResFP_im                     : signed(39 DOWNTO 0);  -- sfix40_En28
...
BEGIN
  ...
  adder_add_cast <= resize(din_re_reg, 22);
  adder_add_cast_1 <= resize(din_im_reg, 22);
  ...
  Complex3Add_sub_cast <= resize(prodOfRe, 38);
  Complex3Add_sub_cast_1 <= resize(prodOfIm, 38);
  Complex3Add_multRes_re_reg1_next <= Complex3Add_sub_cast - Complex3Add_sub_cast_1;
  Complex3Add_sub_cast_2 <= resize(Complex3Add_prodOfSum_reg, 40);
  Complex3Add_sub_cast_3 <= resize(Complex3Add_tmpResult_reg, 40);
  Complex3Add_multRes_im_reg_next <= Complex3Add_sub_cast_2 - Complex3Add_sub_cast_3;
  Complex3Add_add_cast <= resize(prodOfRe, 38);
  Complex3Add_add_cast_1 <= resize(prodOfIm, 38);
  Complex3Add_add_temp <= Complex3Add_add_cast + Complex3Add_add_cast_1;
  Complex3Add_tmpResult_reg_next <= resize(Complex3Add_add_temp, 39);
  multResFP_re <= Complex3Add_multRes_re_reg2;
  multResFP_im <= Complex3Add_multRes_im_reg;

  dinXTwdl_re_tmp <= multResFP_re(34 DOWNTO 14);

  dinXTwdl_re <= std_logic_vector(dinXTwdl_re_tmp);

  dinXTwdl_im_tmp <= multResFP_im(34 DOWNTO 14);
