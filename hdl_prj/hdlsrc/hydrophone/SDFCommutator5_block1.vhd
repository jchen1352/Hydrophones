-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hydrophone\SDFCommutator5_block1.vhd
...
-- Source Path: hydrophone/Subsystem/FFT HDL Optimized2/RADIX22FFT_SDF1_5/SDFCommutator5
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  u_dataXMEM_re_0_5 : SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_5 : SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 21
                 )
    PORT MAP( clk => clk,
  ...
  SDFCummutator_output : PROCESS (SDFCummutator_out_re, SDFCummutator_out_im, SDFCummutator_out_vld,
       ...
       dinXTwdlf_re_signed, dinXTwdlf_im_signed, dinxTwdlf_vld, btf1_re_signed,
       btf1_im_signed, btf2_re_signed, btf2_im_signed, btf_vld)
  BEGIN
