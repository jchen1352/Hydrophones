-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hydrophone\RADIX22FFT_CTRL1_7_block1.vhd
...
-- Source Path: hydrophone/Subsystem/FFT HDL Optimized2/RADIX22FFT_CTRL1_7
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX22FFT_CTRL1_7_block1 IS
  ...
  SIGNAL rd_7_Addr_tmp                    : unsigned(2 DOWNTO 0);  -- ufix3
...
BEGIN
  ...
  SDFController_output : PROCESS (SDFController_wrCount, SDFController_wrState, SDFController_rdState,
       ...
       SDFController_multjState, SDFController_multiply_J_reg, dinXTwdl_7_1_vld,
       dinXTwdl_7_1_vld_1)
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_7_Enb <= '0';
        IF (dinXTwdl_7_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#7#, 3))) = '1' THEN 
