-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hydrophone\SDFCommutator7_block1.vhd
...
-- Source Path: hydrophone/Subsystem/FFT HDL Optimized2/RADIX22FFT_SDF1_7/SDFCommutator7
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  u_dataXMEM_re_0_7 : SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_7 : SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 23
                 )
    PORT MAP( clk => clk,
  ...
  SDFCummutator_output : PROCESS (SDFCummutator_out_re, SDFCummutator_out_im, SDFCummutator_out_vld,
       ...
       SDFCummutator_xX_vld_reg, din_7_vld_dly, dinXTwdlf_re_signed,
