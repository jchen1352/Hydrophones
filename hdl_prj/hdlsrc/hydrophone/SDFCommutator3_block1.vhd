-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hydrophone\SDFCommutator3_block1.vhd
...
-- Source Path: hydrophone/Subsystem/FFT HDL Optimized2/RADIX22FFT_SDF1_3/SDFCommutator3
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
  ...
  BEGIN
    ...
    CASE SDFCummutator_mem_btf_switch IS
      ...
      WHEN "01" =>
        SDFCummutator_mem_btf_switch_next <= to_unsigned(16#1#, 2);
        SDFCummutator_rdEnb_xmem_next <= '0';
        IF (hdlcoder_to_stdlogic(SDFCummutator_rdCnt = to_unsigned(16#7F#, 7)) AND btf_vld) = '1' THEN 
