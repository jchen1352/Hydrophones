-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hydrophone\RADIX22FFT_SDF1_9_block1.vhd
...
-- Source Path: hydrophone/Subsystem/FFT HDL Optimized2/RADIX22FFT_SDF1_9
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX22FFT_SDF1_9_block1 IS
  ...
  SIGNAL wrData_im_signed                 : signed(24 DOWNTO 0);  -- sfix25_En14
  SIGNAL wrData_re                        : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL wrData_re_signed                 : signed(24 DOWNTO 0);  -- sfix25_En14
  SIGNAL wrAddr                           : std_logic;  -- ufix1
  SIGNAL wrEnb                            : std_logic;
  SIGNAL twoLocationReg_0_MEM_re_0        : signed(24 DOWNTO 0);  -- sfix25
  SIGNAL twoLocationReg_0_MEM_im_0        : signed(24 DOWNTO 0);  -- sfix25
  SIGNAL twoLocationReg_0_MEM_re_1        : signed(24 DOWNTO 0);  -- sfix25
  SIGNAL twoLocationReg_0_MEM_im_1        : signed(24 DOWNTO 0);  -- sfix25
  SIGNAL twoLocationReg_0_dout_re_reg     : signed(24 DOWNTO 0);  -- sfix25
  SIGNAL twoLocationReg_0_dout_im_reg     : signed(24 DOWNTO 0);  -- sfix25
  SIGNAL twoLocationReg_0_MEM_re_0_next   : signed(24 DOWNTO 0);  -- sfix25_En14
  SIGNAL twoLocationReg_0_MEM_im_0_next   : signed(24 DOWNTO 0);  -- sfix25_En14
  SIGNAL twoLocationReg_0_MEM_re_1_next   : signed(24 DOWNTO 0);  -- sfix25_En14
  SIGNAL twoLocationReg_0_MEM_im_1_next   : signed(24 DOWNTO 0);  -- sfix25_En14
  SIGNAL twoLocationReg_0_dout_re_reg_next : signed(24 DOWNTO 0);  -- sfix25_En14
  SIGNAL twoLocationReg_0_dout_im_reg_next : signed(24 DOWNTO 0);  -- sfix25_En14
  SIGNAL x_re                             : signed(24 DOWNTO 0);  -- sfix25_En14
  SIGNAL x_im                             : signed(24 DOWNTO 0);  -- sfix25_En14
...
BEGIN
  u_MUL3 : Complex3Multiply_block10
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  BEGIN
    IF reset = '1' THEN
      twoLocationReg_0_MEM_re_0 <= to_signed(16#0000000#, 25);
      twoLocationReg_0_MEM_im_0 <= to_signed(16#0000000#, 25);
      twoLocationReg_0_MEM_re_1 <= to_signed(16#0000000#, 25);
      twoLocationReg_0_MEM_im_1 <= to_signed(16#0000000#, 25);
      twoLocationReg_0_dout_re_reg <= to_signed(16#0000000#, 25);
      twoLocationReg_0_dout_im_reg <= to_signed(16#0000000#, 25);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  twoLocationReg_0_output : PROCESS (twoLocationReg_0_MEM_re_0, twoLocationReg_0_MEM_im_0,
       ...
       wrData_re_signed, wrData_im_signed, wrAddr, wrEnb, rd_9_Addr)
  BEGIN
