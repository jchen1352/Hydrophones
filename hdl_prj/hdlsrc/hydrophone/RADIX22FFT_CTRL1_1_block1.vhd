-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hydrophone\RADIX22FFT_CTRL1_1_block1.vhd
...
-- Source Path: hydrophone/Subsystem/FFT HDL Optimized2/RADIX22FFT_CTRL1_1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX22FFT_CTRL1_1_block1 IS
  ...
  SIGNAL rd_1_Addr_tmp                    : unsigned(8 DOWNTO 0);  -- ufix9
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_1_Enb <= '0';
        IF (dinXTwdl_1_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#1FF#, 9))) = '1' THEN 
