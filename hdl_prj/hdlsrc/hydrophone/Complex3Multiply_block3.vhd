-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hydrophone\Complex3Multiply_block3.vhd
...
-- Source Path: hydrophone/Subsystem/FFT HDL Optimized1/RADIX22FFT_SDF1_3/Complex3Multiply
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Complex3Multiply_block3 IS
  ...
  SIGNAL adder_add_cast                   : signed(19 DOWNTO 0);  -- sfix20_En14
  SIGNAL adder_add_cast_1                 : signed(19 DOWNTO 0);  -- sfix20_En14
  SIGNAL din_sum                          : signed(19 DOWNTO 0);  -- sfix20_En14
  ...
  SIGNAL Complex3Multiply_din1_re_pipe1   : signed(18 DOWNTO 0);  -- sfix19
  SIGNAL Complex3Multiply_din1_im_pipe1   : signed(18 DOWNTO 0);  -- sfix19
  SIGNAL Complex3Multiply_din1_sum_pipe1  : signed(19 DOWNTO 0);  -- sfix20
  SIGNAL Complex3Multiply_prodOfRe_pipe1  : signed(34 DOWNTO 0);  -- sfix35
  SIGNAL Complex3Multiply_ProdOfIm_pipe1  : signed(34 DOWNTO 0);  -- sfix35
  SIGNAL Complex3Multiply_prodOfSum_pipe1 : signed(36 DOWNTO 0);  -- sfix37
  ...
  SIGNAL prodOfRe                         : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL prodOfIm                         : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL prodOfSum                        : signed(36 DOWNTO 0);  -- sfix37_En28
  ...
  SIGNAL Complex3Add_tmpResult_reg_next   : signed(36 DOWNTO 0);  -- sfix37_En28
  SIGNAL Complex3Add_multRes_re_reg1_next : signed(35 DOWNTO 0);  -- sfix36_En28
  SIGNAL Complex3Add_multRes_re_reg2_next : signed(35 DOWNTO 0);  -- sfix36_En28
  SIGNAL Complex3Add_multRes_im_reg_next  : signed(37 DOWNTO 0);  -- sfix38_En28
  SIGNAL Complex3Add_sub_cast             : signed(35 DOWNTO 0);  -- sfix36_En28
  SIGNAL Complex3Add_sub_cast_1           : signed(35 DOWNTO 0);  -- sfix36_En28
  SIGNAL Complex3Add_sub_cast_2           : signed(37 DOWNTO 0);  -- sfix38_En28
  SIGNAL Complex3Add_sub_cast_3           : signed(37 DOWNTO 0);  -- sfix38_En28
  SIGNAL Complex3Add_add_cast             : signed(35 DOWNTO 0);  -- sfix36_En28
  SIGNAL Complex3Add_add_cast_1           : signed(35 DOWNTO 0);  -- sfix36_En28
  SIGNAL Complex3Add_add_temp             : signed(35 DOWNTO 0);  -- sfix36_En28
  SIGNAL multResFP_re                     : signed(35 DOWNTO 0);  -- sfix36_En28
  SIGNAL multResFP_im                     : signed(37 DOWNTO 0);  -- sfix38_En28
...
BEGIN
  ...
  dinXTwdl_re_tmp <= multResFP_re(32 DOWNTO 14);

  dinXTwdl_re <= std_logic_vector(dinXTwdl_re_tmp);

  dinXTwdl_im_tmp <= multResFP_im(32 DOWNTO 14);
