-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hydrophone\TWDLROM_5_1_block1.vhd
...
-- Source Path: hydrophone/Subsystem/FFT HDL Optimized2/TWDLROM_5_1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  Radix22TwdlMapping_output : PROCESS (Radix22TwdlMapping_cnt, Radix22TwdlMapping_phase,
       ...
       Radix22TwdlMapping_dvldReg1, Radix22TwdlMapping_dvldReg2, dout_4_1_vld)
  ...
  BEGIN
    ...
    END IF;
    IF (dout_4_1_vld AND hdlcoder_to_stdlogic(Radix22TwdlMapping_cnt > to_unsigned(16#FB#, 8))) = '1' THEN 
      Radix22TwdlMapping_phase_next <= Radix22TwdlMapping_phase + to_unsigned(16#1#, 2);
    END IF;
    IF dout_4_1_vld = '1' THEN 
      Radix22TwdlMapping_cnt_next <= Radix22TwdlMapping_cnt + to_unsigned(16#04#, 8);
    END IF;
