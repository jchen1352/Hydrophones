-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hydrophone\RADIX22FFT_CTRL1_9_block1.vhd
...
-- Source Path: hydrophone/Subsystem/FFT HDL Optimized2/RADIX22FFT_CTRL1_9
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  SDFController_output : PROCESS (SDFController_wrCount, SDFController_wrState, SDFController_rdState,
       ...
       SDFController_multjState, SDFController_multiply_J_reg, dinXTwdl_9_1_vld,
       dinXTwdl_9_1_vld_1)
  BEGIN
