-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hydrophone\RADIX22FFT_CTRL1_3_block1.vhd
...
-- Source Path: hydrophone/Subsystem/FFT HDL Optimized2/RADIX22FFT_CTRL1_3
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX22FFT_CTRL1_3_block1 IS
  ...
  SIGNAL rd_3_Addr_tmp                    : unsigned(6 DOWNTO 0);  -- ufix7
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_3_Enb <= '0';
        IF (dinXTwdl_3_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#7F#, 7))) = '1' THEN 
