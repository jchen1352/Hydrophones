-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hydrophone\RADIX22FFT_SDF2_8_block1.vhd
...
-- Source Path: hydrophone/Subsystem/FFT HDL Optimized2/RADIX22FFT_SDF2_8
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  u_dataMEM_im_0_8 : SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_8 : SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 2,
                 DataWidth => 24
                 )
    PORT MAP( clk => clk,
  ...
  Radix22ButterflyG2_output : PROCESS (Radix22ButterflyG2_procEnb_dly, Radix22ButterflyG2_procEnb_dly1,
       ...
       din_re, din_im, dinVld, din_re, din_im, btfin_vld, x_re_dly, x_im_dly,
       x_vld_dly, multiply_8_J)
