-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hydrophone\SDFCommutator9_block1.vhd
...
-- Source Path: hydrophone/Subsystem/FFT HDL Optimized2/RADIX22FFT_SDF1_9/SDFCommutator9
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  u_dataXMEM_re_0_9 : SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_9 : SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 25
                 )
    PORT MAP( clk => clk,
  ...
  SDFCummutator_output : PROCESS (SDFCummutator_out_re, SDFCummutator_out_im, SDFCummutator_out_vld,
       ...
       SDFCummutator_xX_vld_reg, din_9_vld_dly, dinXTwdlf_re_signed,
       dinXTwdlf_im_signed, dinxTwdlf_vld, btf1_re_signed, btf1_im_signed,
       btf2_re_signed, btf2_im_signed, btf_vld)
