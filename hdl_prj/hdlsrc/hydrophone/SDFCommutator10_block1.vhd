-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hydrophone\SDFCommutator10_block1.vhd
...
-- Source Path: hydrophone/Subsystem/FFT HDL Optimized2/RADIX22FFT_SDF2_10/SDFCommutator10
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SDFCommutator10_block1 IS
  ...
  SIGNAL SDFCummutator_btf1_re_dly_next   : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL SDFCummutator_btf1_im_dly_next   : signed(25 DOWNTO 0);  -- sfix26_En14
...
BEGIN
  ...
  SDFCummutator_output : PROCESS (SDFCummutator_out_re, SDFCummutator_out_im, SDFCummutator_out_vld,
       ...
       SDFCummutator_xX_vld_reg, SDFCummutator_btf1_re_dly,
       SDFCummutator_btf1_im_dly, SDFCummutator_btf1_vld_dly, dinf_re_signed,
       dinf_im_signed, dinf_vld, btf1_re_signed, btf1_im_signed, btf2_re_signed,
       btf2_im_signed, btfout_vld)
  BEGIN
  ...
  SDFOutmux_output : PROCESS (SDFOutmux_btf2Pipe_re, SDFOutmux_btf2Pipe_im, SDFOutmux_btfPipe_vld, dout0_re,
       dout0_im, dout0_vld, xX_re_signed, xX_im_signed, xX_vld)
  BEGIN
