-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hydrophone\RADIX22FFT_CTRL1_6_block1.vhd
...
-- Source Path: hydrophone/Subsystem/FFT HDL Optimized2/RADIX22FFT_CTRL1_6
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX22FFT_CTRL1_6_block1 IS
  ...
  SIGNAL rd_6_Addr_tmp                    : unsigned(3 DOWNTO 0);  -- ufix4
...
BEGIN
  ...
  SDFController_output : PROCESS (SDFController_wrCount, SDFController_wrState, SDFController_rdState,
       ...
       SDFController_multjState, SDFController_multiply_J_reg, dout_5_1_vld,
       dinXTwdl_6_1_vld)
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_6_Enb <= '0';
        IF (dout_5_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#F#, 4))) = '1' THEN 
