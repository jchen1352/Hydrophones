-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hydrophone\SDFCommutator4_block1.vhd
...
-- Source Path: hydrophone/Subsystem/FFT HDL Optimized2/RADIX22FFT_SDF2_4/SDFCommutator4
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  u_dataXMEM_re_0_4 : SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_4 : SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 20
                 )
    PORT MAP( clk => clk,
  ...
  SDFCummutator_output : PROCESS (SDFCummutator_out_re, SDFCummutator_out_im, SDFCummutator_out_vld,
       ...
       SDFCummutator_xX_vld_reg, xf_re_signed, xf_im_signed, xf_vld,
       dinf_re_signed, dinf_im_signed, dinf_vld, btf1_re_signed, btf1_im_signed,
       btf2_re_signed, btf2_im_signed, btfout_vld)
  BEGIN
    ...
    CASE SDFCummutator_mem_btf_switch IS
      ...
      WHEN "01" =>
        SDFCummutator_mem_btf_switch_next <= to_unsigned(16#1#, 2);
        SDFCummutator_rdEnb_xmem_next <= '0';
        IF (hdlcoder_to_stdlogic(SDFCummutator_rdCnt = to_unsigned(16#3F#, 6)) AND btfout_vld) = '1' THEN 
