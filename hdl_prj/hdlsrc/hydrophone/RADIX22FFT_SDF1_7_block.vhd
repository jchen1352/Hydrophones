-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hydrophone\RADIX22FFT_SDF1_7_block.vhd
...
-- Source Path: hydrophone/Subsystem/FFT HDL Optimized1/RADIX22FFT_SDF1_7
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  u_MUL3 : Complex3Multiply_block5
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
