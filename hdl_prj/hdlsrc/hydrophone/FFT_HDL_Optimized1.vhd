-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hydrophone\FFT_HDL_Optimized1.vhd
...
-- Source Path: hydrophone/Subsystem/FFT HDL Optimized1
-- Hierarchy Level: 1
-- 
-- FFT HDL Optimized
-- 
...
ARCHITECTURE rtl OF FFT_HDL_Optimized1 IS
  ...
  COMPONENT RADIX2FFT_bitNatural_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : RADIX2FFT_bitNatural_block
    USE ENTITY work.RADIX2FFT_bitNatural_block(rtl);
...
BEGIN
  ...
  u_NaturalOrder_Stage : RADIX2FFT_bitNatural_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_10_1_re => dout_10_1_re,  -- sfix26_En14
