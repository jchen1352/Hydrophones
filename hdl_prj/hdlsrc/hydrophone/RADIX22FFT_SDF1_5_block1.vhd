-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hydrophone\RADIX22FFT_SDF1_5_block1.vhd
...
-- Source Path: hydrophone/Subsystem/FFT HDL Optimized2/RADIX22FFT_SDF1_5
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  u_MUL3 : Complex3Multiply_block8
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_dataMEM_im_0_5 : SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_5 : SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 21
                 )
    PORT MAP( clk => clk,
