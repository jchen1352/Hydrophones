-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\hydrophone\SDFCommutator8_block1.vhd
...
-- Source Path: hydrophone/Subsystem/FFT HDL Optimized2/RADIX22FFT_SDF2_8/SDFCommutator8
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  u_dataXMEM_re_0_8 : SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_8 : SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 24
                 )
    PORT MAP( clk => clk,
  ...
  SDFCummutator_output : PROCESS (SDFCummutator_out_re, SDFCummutator_out_im, SDFCummutator_out_vld,
       ...
       SDFCummutator_xX_vld_reg, dout_7_1_vld, dinf_re_signed, dinf_im_signed,
       dinf_vld, btf1_re_signed, btf1_im_signed, btf2_re_signed, btf2_im_signed,
       btfout_vld)
  BEGIN
